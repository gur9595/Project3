	...
	<div id="wrap">
		...
		<div class="main_contents">
			<div class="main_con_left">
				...
				%>
				<form action="../member/common/LoginProcess.jsp" method="post" name="loginFrm" onsubmit="return loginValidate(this);">
					...
					<p>
						<input type="checkbox" name="id_save" <%if(user.length()!=0){ %> checked="checked"<% } %>/><img src="../images/login_tit03.gif" alt="저장" />
