			...
			<div class="contents_box">
				...
				<div class="right_contents">
					...
					<div>
						...
						<%}else if(bname.equals("info")){ %>
						<form action="./common/UploadProc.jsp" name="writeFrm" method="post" 
						...
						<%}else if(bname.equals("photo")){ %>
							<form action="./common/UploadProc_img.jsp" name="writeFrm" method="post"  enctype="multipart/form-data">
							<input type="hidden" name="bname" value="<%=bname%>" />
							<table class="table table-bordered">
								<colgroup>
									<col width="20%" />
